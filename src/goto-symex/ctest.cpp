...
/// Write esbmc_verifier.h with extern "C" forward declarations for all
/// __VERIFIER_* functions.
///
/// Real-world C++ programs verified by ESBMC may call these functions
/// without any declaration (ESBMC provides them internally). When the
/// generated test cases are compiled, the C++ compiler requires explicit
/// declarations. This header is force-included via CMake
/// target_compile_options so that no modification to the original source
/// file is needed.
static void write_verifier_header()
{
  std::ofstream h("esbmc_verifier.h");
  h << "// Auto-generated by ESBMC " << ESBMC_VERSION << "\n";
  h << "// Forward declarations for __VERIFIER_* functions\n";
  h << "#pragma once\n\n";
  h << "#ifdef __cplusplus\n";
  h << "extern \"C\" {\n";
  h << "#endif\n\n";
...
/// target_compile_options. This lets C++ source files that call
/// __VERIFIER_* without their own extern "C" declarations compile without
/// errors.
