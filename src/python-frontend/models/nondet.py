...
def nondet_list(max_size: int = _DEFAULT_NONDET_SIZE, elem_type: Any = None) -> list:
    ...
    Note:
        The preprocessor expands this call inline so that each element gets
        a fresh nondeterministic value. The model function body below is kept
        as fallback for non-expanded contexts.
    """
